...
mods.inworldcrafting.FluidToItem.transform(electrotine * 4, destRedstone, dustElectrum);

mods.inworldcrafting.FluidToFluid.transform(<liquid:water>, destRedstone, dustElectrum, false);